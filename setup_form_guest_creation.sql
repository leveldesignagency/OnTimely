-- ============================================
-- SETUP FORM SUBMISSION AND GUEST CREATION
...
BEGIN
  ...
  SELECT 
    ...
    f.company_id,
    f.fields
  INTO v_form_id, v_recipient_id, v_event_id, v_company_id, v_form_data
...
-- SELECT submit_form_and_create_guest('test-token', 'test@example.com', '{"firstName": "John", "lastName": "Doe"}'::jsonb); 