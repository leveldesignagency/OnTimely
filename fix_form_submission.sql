-- Fix form submission and create guest function
...
-- 2. Drop the function if it exists and recreate it
DROP FUNCTION IF EXISTS submit_form_and_create_guest(TEXT, TEXT, JSONB);

-- 3. Create the function properly
...
-- 6. Test the function with a sample token (replace with actual token)
-- SELECT submit_form_and_create_guest('your_token_here', 'test@example.com', '{"firstName": "Test", "lastName": "User"}'::jsonb); 